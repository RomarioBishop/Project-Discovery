                ...
                <form action="settings.php" method="post">
                    <div class="uneditable">
                        ...
                        <div>
                            ...
                            <p class="member-name">Ode Millington</p> 
                            <!--REPLACE MY NAME WITH DATABASE NAME-->
                        </div>

                        <div>
                            <p class="member-email-title">EMAIL</p>
                            <p class="member-email">odemillington05@gmail.com</p> 
                            <!--REPLACE MY EMAIL WITH DATABASE NAME-->
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" id="password3" name="newpwd">
                            <p class="underline"></p>
                        </div>
